...
Original file is located at
    https://colab.research.google.com/drive/15JgXofvbD2y5f5v6OOQNG3Clzgh33pDi
"""
...
greedy_output = model.generate(input_ids, num_beams=7, no_repeat_ngram_size=2, min_length=300, max_length=2000)
